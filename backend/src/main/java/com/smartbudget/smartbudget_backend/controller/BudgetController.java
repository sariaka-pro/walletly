...
import com.smartbudget.smartbudget_backend.service.BudgetService;
...
public class BudgetController {
    ...
    public ResponseEntity<YearlyBudgetStatsDto> getYearlyStats(@RequestParam int year,@AuthenticationPrincipal User currentUser) {
        YearlyBudgetStatsDto stats = budgetService.getYearlyStats(currentUser.getId(), year); 
